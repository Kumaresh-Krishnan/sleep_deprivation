...
def plotHistogram(experiment, num_bins, prob=False):
    ...
    for stimulus in range(stimuli):
        ...
        ax.bar(x_vals, first_2[stimulus] / norm_2[stimulus], width=0.1, yerr= sem_first_2[stimulus] / norm_2[stimulus], alpha=0.7, label='0.001 μM Melatonin', color = 'xkcd:aquamarine' )
        ...
        ax2.bar(x_vals, first_correct_2[stimulus] / norm_c_2[stimulus], width=0.1, yerr= sem_first_correct_2[stimulus] / norm_c_2[stimulus], alpha=0.7, label='0.001 μM Melatonin', color = 'xkcd:aquamarine' )
    ...
    for stimulus in range(half):
        ...
        ax.plot(x_vals, first_2[stimulus] / norm_2[stimulus], label='0.001 μM Melatonin', color='xkcd:aquamarine')

        ax2.plot(x_vals, first_correct_1[stimulus] / norm_c_1[stimulus], label='control', color='xkcd:greyish blue')
        ax2.plot(x_vals, first_correct_2[stimulus] / norm_c_2[stimulus], label='0.001 μM Melatonin', color='xkcd:aquamarine')
